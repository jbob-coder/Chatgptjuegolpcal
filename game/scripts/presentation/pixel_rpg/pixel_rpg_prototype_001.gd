...
const ConceptGatePillars012A := preload("res://scripts/presentation/pixel_rpg/concept_gate_pillars_012a.gd")
...
func _build_prototype_world() -> void:
	...
	var concept_gate_pillars := ConceptGatePillars012A.new() as Node3D
	world_geometry.add_child(concept_gate_pillars)
