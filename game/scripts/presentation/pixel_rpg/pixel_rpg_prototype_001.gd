...
@onready var hunter_visual: Node3D = $Hunter/Visual
@onready var camera_yaw: Node3D = $Hunter/CameraYaw
@onready var camera_pitch: Node3D = $Hunter/CameraYaw/CameraPitch
@onready var camera: Camera3D = $Hunter/CameraYaw/CameraPitch/Camera3D
