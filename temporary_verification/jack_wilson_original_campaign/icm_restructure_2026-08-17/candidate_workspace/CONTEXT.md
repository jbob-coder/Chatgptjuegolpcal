...
`00_BOOTSTRAP`, `01_CANON`, `02_WORLD`, `03_CHARACTERS`, `04_LOCATIONS`, `05_EVENTS`, `06_RELATIONSHIPS`, `07_QUESTS`, `08_ITEMS`, `09_ABILITIES`, `10_SYSTEMS`, `11_SIMULATION`, `12_VALIDATION`, `13_BATCH_HISTORY`, `99_BACKUPS`.

## Context loading
Load only: this file, the active stage `CONTEXT.md`, the explicit inputs named there, and the minimum target game files needed. Do not crawl the whole Drive tree and do not load source-story files.
