...
Status: ACTIVE GLOBAL MAP / FIRST-PERSON + VISUAL PACK 010 IMAGE-DERIVED ASSET BUILDIDENTITY AUTHORITY
...
The image is both a direction/composition reference and, for Visual Pack 010, an actual pixel source for derived runtime textures. Visible names, quest text, counts and labels remain placeholders unless separately approved.
