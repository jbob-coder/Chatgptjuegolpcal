...
Status: ACTIVE GLOBAL MAP / STAGE 1 PHONE GATE DEFERRED / FIVE CORE COMBAT CONTRACTS RECORDED / STATUS SET NEXT
...
39. `docs/20_gameplay/combat/INITIATIVE_AND_TURN_ORDER_PROTOTYPE_CONTRACT.md` — newest core combat contract.
40. `docs/70_handoff/INITIATIVE_AND_TURN_ORDER_PASS_2026-09-03.md` — bounded Initiative design pass.
41. `NEW_GAME_MASTER_PLAN.md`
42. `MECHANICAL_SYSTEMS_GUIDE.md`
43. `STATS_ATTRIBUTES_EFFECTS_SYSTEM.md`
44. `CONTENT_DATA_GUIDE.md`
45. `BEHAVIOR_PATTERN_SYSTEM.md`
46. `CRYSTAL_MUTATION_ECOSYSTEM_SYSTEM.md`

Current five core combat contracts record:
...
- tie order `Rating DESC → Agility DESC → Perception DESC → stable combatant ID ASC`;
...
- save/reload cannot duplicate consumed slots/resource-refresh hooks.
...
47. `docs/30_content/README.md`
48. `docs/30_content/hunters/HUNTER_BASE_01/README.md`
49. `docs/30_content/hunters/HUNTER_BASE_01/PROPORTION_AND_ATTACHMENT_CONTRACT.md`
50. `docs/30_content/monsters/MONSTER_01/README.md`
51. `docs/30_content/monsters/MONSTER_01/ANATOMY_AND_DAMAGE.md`
52. `docs/30_content/monsters/MONSTER_01/CRYSTAL_AND_MUTATION.md`
53. `docs/30_content/monsters/MONSTER_01/BEHAVIOR_AND_REGION.md`
...
54. `docs/40_art/README.md`
55. `docs/40_art/asset_pipeline/README.md`
56. `docs/40_art/asset_pipeline/ASSET_LINEAGE_AND_APPROVAL_MANIFEST.md`
57. `docs/40_art/asset_pipeline/RASTER_RESOLUTION_AND_ZOOM_QUALITY.md`
58. `docs/40_art/asset_pipeline/RUNTIME_2D_ASSET_GUIDE.md`
59. `docs/40_art/asset_pipeline/PNG_TO_3D_AUTOMATION_PIPELINE.md`
60. `docs/40_art/asset_pipeline/ASSET_QA_GATES.md`
61. `docs/40_art/asset_pipeline/HUNTER_TECHNICAL_SOURCE_PACK_STANDARD.md`
62. `docs/40_art/asset_pipeline/HUNTER_DCC_BLOCKOUT_SPECIFICATION.md`
63. `docs/40_art/reviews/README.md`

## Layer 6 — architecture / code / technical

64. `SYSTEM_ARCHITECTURE_BLUEPRINT.md`
65. `CODE_GUIDE.md`
66. `CONTENT_DATA_GUIDE.md`
67. `docs/50_technical/README.md`
68. `NEW_GAME_ARCHITECTURE_VISUAL_BIBLE.md` only where not superseded by newer authorities.

## Layer 7 — quality / performance / debug

69. `PERFORMANCE_BUDGETS_AND_CAPS.md`
70. `TESTING_VERIFICATION_PLAN.md`
71. `ADMIN_CREATOR_SYSTEM.md`
72. `docs/60_quality/README.md`
73. `probes/android_stage1/docs/SUSTAINED_PERFORMANCE_EVIDENCE_PROTOCOL.md`.
...
# 4. Documentation maintenance law

When durable truth changes:
1. update the owning source/system/package authority;
2. update local README/file map when local navigation/status changes;
3. update this index when important authority/read order/navigation changes;
4. update `PROJECT_HANDOFF.md`, `START_HERE_NEW_CHAT.md`, root README and EVOLVE when current state/next action changes;
...
7. save/commit and read back;
8. never let stale chat memory or old status text override current repository evidence.

An important new authority that cannot be found through its local README or this index is incompletely integrated documentation.
