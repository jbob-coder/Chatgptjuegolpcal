...
Status: ACTIVE GLOBAL MAP / FIRST-PERSON + STARTING AREA ASSET PACK 005 GATE WARDEN BUILDIDENTITY AUTHORITY
...
Next bounded slice: `PIXEL_RPG_STARTING_AREA_ASSET_PACK_006_SETTLEMENT_BUILDING_DETAILS`.

Preserve creator-authoritative first-person presentation, current world transforms/collision ownership, Gate Warden interaction, Pack 004 smith doorway/anchors, Bridge 001 targeting, Bridge 002 no-attack bootstrap and State Ownership 001. Improve only generic building presentation.
