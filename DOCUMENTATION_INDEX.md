...
Status: ACTIVE GLOBAL MAP / FIRST-PERSON + STARTING AREA ASSET PACK 002 SMITH BUILDIDENTITY AUTHORITY
...
Next bounded slice: `PIXEL_RPG_STARTING_AREA_ASSET_PACK_003_ENVIRONMENT_DRESSING`.

Preserve creator-authoritative first-person presentation, current world transforms/collision ownership, Pack 004 smith doorway/anchors, Bridge 001 targeting, Bridge 002 no-attack bootstrap and State Ownership 001. Improve environmental presentation only.
