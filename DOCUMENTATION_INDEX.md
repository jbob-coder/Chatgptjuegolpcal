...
Status: ACTIVE GLOBAL MAP / FIRST-PERSON + STARTING AREA ASSET PACK 004 BUILDIDENTITY AUTHORITY
...
Next bounded slice: `PIXEL_RPG_STARTING_AREA_ASSET_PACK_005_GATE_WARDEN_VISUAL`.

Preserve creator-authoritative first-person presentation, current world transforms/collision ownership, Pack 004 smith doorway/anchors, Bridge 001 targeting, Bridge 002 no-attack bootstrap and State Ownership 001. Replace only Gate Warden presentation and keep interaction authority unchanged.
