...
Piece 015 candidate inventory: 7 QA validators + 10 static tests = 17 checks. Sixteen pass in the current stale clone; only `verify_project_state.py` fails at ISSUE-007's missing connector-written local commit object. Baseline counts above remain the last fully passing Piece 014 implementation run rather than falsely promoting the candidate to 17/17.
