...
4. `project_control/ROADMAP.md` — the ordered construction sequence from source bridge to full-city runtime streaming.
...
| `scripts/world/` | GAME_RUNTIME, future | Coordinate conversion, loading, chunking, streaming, and spatial queries | QA-only validators |
