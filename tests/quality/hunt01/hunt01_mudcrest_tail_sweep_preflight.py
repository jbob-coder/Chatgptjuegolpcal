...
def main() -> int:
    ...
    check("runtime doc preserves provisional/sever/Staggered boundaries", "AUTOMATED VERIFICATION PENDING" in doc and "TAIL_DISTAL" in doc and "Staggered" in doc and "provisional" in doc.lower())
    check("Monster README records Tail Sweep implementation ownership", "M01_TAIL_SWEEP" in monster_readme and "3 AP / 18 Stamina" in monster_readme)
