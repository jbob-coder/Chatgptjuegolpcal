...
Status: ACTIVE PIXEL RPG / FIRST-PERSON + VISUAL PACK 008 MUDCREST BUILD-VERIFIED / SAFE VISUAL CONTINUATION
...
## Starting Area Asset Pack 002 Smith Visual exact-source checkpoint
...
2. do not replace or move the active camera and do not change its FOV/near/far contract;
3. viewmodel owns no collision, input, target selection, attack, damage, AP/Stamina or durable state;
4. preserve Hunter controller/collision, first-person movement/look, Mudcrest targeting/highlights, Bridge 002 no-attack bootstrap and State Ownership 001;
...
NEXT THING: `PIXEL_RPG_VISUAL_PACK_009_FIRST_PERSON_VIEWMODEL`.
